...
public class welcomeActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.welcome2); // Gets the layout of the screen from welcome.xml and sets it according to that.
        ...
        Button sedentary = findViewById(R.id.beginnerButton);
        Button lightly = findViewById(R.id.intermediateButton);
        Button moderately = findViewById(R.id.advancedButton);
        Button veryActive = findViewById(R.id.eliteButton);
        sedentary.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                activityValue = "sedentary";
                sedentary.setBackgroundColor(Color.parseColor("#444343"));
                lightly.setBackgroundColor(Color.parseColor("#00444343"));
                moderately.setBackgroundColor(Color.parseColor("#00444343"));
                veryActive.setBackgroundColor(Color.parseColor("#00444343"));
            }
        });
        ...
        lightly.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                activityValue = "lightlyActive";
                lightly.setBackgroundColor(Color.parseColor("#444343"));
                sedentary.setBackgroundColor(Color.parseColor("#00444343"));
                moderately.setBackgroundColor(Color.parseColor("#00444343"));
                veryActive.setBackgroundColor(Color.parseColor("#00444343"));
            }
        });
        ...
        moderately.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                activityValue = "moderatelyActive";
                moderately.setBackgroundColor(Color.parseColor("#444343"));
                sedentary.setBackgroundColor(Color.parseColor("#00444343"));
                lightly.setBackgroundColor(Color.parseColor("#00444343"));
                veryActive.setBackgroundColor(Color.parseColor("#00444343"));
            }
        ...
        veryActive.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                activityValue = "veryActive";
                veryActive.setBackgroundColor(Color.parseColor("#444343"));
                sedentary.setBackgroundColor(Color.parseColor("#00444343"));
                lightly.setBackgroundColor(Color.parseColor("#00444343"));
                moderately.setBackgroundColor(Color.parseColor("#00444343"));
            }
